...
from app.domains.recipient.schemas import RecipientCreateRequest, RecipientSexCode
from app.domains.recipient.service import RecipientService


def test_recipient_test_sex_code_is_accepted_and_round_trips() -> None:
    payload = RecipientCreateRequest(
        name="합성 수급자",
        birth_date=date(1990, 1, 1),
        sex_code=RecipientSexCode.TEST,
        mobile_phone="010-0000-0000",
    )
    assert payload.sex_code is RecipientSexCode.TEST
